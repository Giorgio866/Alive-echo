...
object ModelCatalog {
    val models: List<HfModel> = listOf(
        ...
        HfModel(
            id = "fast-phone",
            name = "Immagini veloci (consigliato)",
            repo = "phone/fast",
            file = "turbo",
            sizeLabel = "nessun download",
            description = "Genera subito sul telefono, senza caricare 3 GB in RAM. Nessun filtro extra nell'app.",
            tags = listOf("immagini", "veloce", "uncensored"),
            kind = ModelKind.IMAGE,
        ),
        HfModel(
            id = "janus-pro-1b",
            name = "Janus Pro 1B ONNX (troppo pesante)",
            repo = "onnx-community/Janus-Pro-1B-ONNX",
            file = "q4",
            sizeLabel = "~3 GB · serve 2+ GB RAM",
            description = "Non entra nella RAM dei telefoni normali (errore buffer 1 GB). Usa Immagini veloci.",
            tags = listOf("immagini", "pesante"),
            kind = ModelKind.IMAGE,
        ),
        HfModel(
            id = "janus-13b",
            name = "Janus 1.3B ONNX (troppo pesante)",
            repo = "onnx-community/Janus-1.3B-ONNX",
            file = "q4",
            sizeLabel = "troppo grande",
            description = "Troppo pesante per il telefono. Usa Immagini veloci.",
            tags = listOf("immagini", "pesante"),
            kind = ModelKind.IMAGE,
        ),
        HfModel(
            id = "sd21-onnx",
            name = "Stable Diffusion 2.1 ONNX (troppo pesante)",
